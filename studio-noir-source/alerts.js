...
(() => {
  ...
  const EVENTS = {
    follower:   { glyph:"+",  kicker:"NEW FOLLOWER",  sub:"",   motion:"follower",   motes:18, amount:false },
    subscriber: { glyph:"▲", kicker:"NEW SUBSCRIBER", sub:"", motion:"subscriber", motes:22, amount:false },
    member:     { glyph:"◈", kicker:"NEW MEMBER", sub:"",        motion:"member",     motes:22, amount:false },
    cheer:      { glyph:"◆", kicker:"CHEER",      sub:"",        motion:"cheer",      motes:26, amount:true,  amtPre:"", amtSuf:" BITS" },
    donation:   { glyph:"■", kicker:"DONATION",   sub:"",       motion:"donation",   motes:28, amount:true,  amtPre:"$" },
    host:       { glyph:"▶", kicker:"NOW HOSTING", sub:"",         motion:"host",       motes:34, amount:true,  amtPre:"", amtSuf:" VIEWERS" },
    raid:       { glyph:"»", kicker:"INCOMING RAID", sub:"", motion:"raid",      motes:48, amount:true,  amtPre:"", amtSuf:" RAIDERS" },
    like:       { glyph:"♥", kicker:"NEW LIKE",   sub:"",           motion:"like",       motes:14, amount:false },
    share:      { glyph:"↗", kicker:"SHARED",     sub:"",         motion:"share",      motes:18, amount:false },
    star:       { glyph:"★", kicker:"NEW STAR",   sub:"",         motion:"star",       motes:24, amount:true,  amtPre:"", amtSuf:" STARS" },
    superchat:  { glyph:"◉", kicker:"SUPER CHAT", sub:"",        motion:"superchat",  motes:30, amount:true,  amtPre:"$" },
    supporter:  { glyph:"❖", kicker:"NEW SUPPORTER", sub:"",  motion:"supporter",  motes:24, amount:false },
  };
