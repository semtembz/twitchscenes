...
(() => {
  ...
  const EVENTS = {
    follower:   { glyph: "❧", kicker: "NEW FOLLOWER",   sub: "", motes: 18, amount: false, anim: "follower" },
    subscriber: { glyph: "✠", kicker: "NEW SUBSCRIBER", sub: "",              motes: 24, amount: false, anim: "subscriber" },
    member:     { glyph: "❖", kicker: "NEW MEMBER",     sub: "",           motes: 24, amount: false, anim: "member" },
    cheer:      { glyph: "✦", kicker: "CHEER",          sub: "",      motes: 28, amount: true,  amtPre: "", amtSuf: " bits", anim: "cheer" },
    donation:   { glyph: "♦", kicker: "DONATION",       sub: "",         motes: 30, amount: true,  amtPre: "$", anim: "donation" },
    host:       { glyph: "⚜", kicker: "NOW HOSTING",    sub: "",           motes: 36, amount: true,  amtPre: "", amtSuf: " guests", anim: "host" },
    raid:       { glyph: "⚔", kicker: "RAID INCOMING",  sub: "",      motes: 50, amount: true,  amtPre: "", amtSuf: " raiders", anim: "raid" },
    like:       { glyph: "❤", kicker: "NEW LIKE",       sub: "",                  motes: 14, amount: false, anim: "like" },
    share:      { glyph: "➤", kicker: "SHARED",         sub: "",     motes: 18, amount: false, anim: "share" },
    star:       { glyph: "★", kicker: "NEW STAR",       sub: "",        motes: 24, amount: true,  amtPre: "", amtSuf: " stars", anim: "star" },
    superchat:  { glyph: "✸", kicker: "SUPER CHAT",     sub: "",  motes: 30, amount: true,  amtPre: "$", anim: "superchat" },
    supporter:  { glyph: "✪", kicker: "NEW SUPPORTER",  sub: "",    motes: 24, amount: false, anim: "supporter" },
  };
