# Green / Neon Overlay Pack

Self-contained streaming graphics in a pixel **neon-green + dark emerald** palette,
matching `starting-soon-neon/`. Drop the folder anywhere and open files in a browser
(or point OBS at them). No internet required.

> This is the green-neon twin of `red-gold-pack/` — same layouts, screens, panels,
> transition and generators, recoloured to the neon-green theme.
